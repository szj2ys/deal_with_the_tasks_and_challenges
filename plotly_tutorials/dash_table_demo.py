    ...
    style_data_conditional=[
        ...
        },
        {
            'if': {
                ...
                'filter_query':
                '{{Pressure}} = {}'.format(df['Pressure'].max())
            },
        ...
        },
        {
            'if': {
                'filter_query':
                '{id} = 4',  # matching rows of a hidden column with the id, `id`
                'column_id': 'Region'
            },
        ...
        },
        {
            'if': {
                'filter_query':
                '{Delivery} > {Date}',  # comparing columns to each other
                'column_id': 'Delivery'
            },
        ...
        },
        {
            'if': {
                'column_type':
                'text'  # 'text' | 'any' | 'datetime' | 'numeric'
            },
            'textAlign': 'left'
        },
        {
